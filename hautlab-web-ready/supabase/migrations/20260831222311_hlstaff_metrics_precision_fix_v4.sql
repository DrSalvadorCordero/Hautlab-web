...
begin
  ...
  if v_staff.id is not null then
    ...
    into v_worked_minutes, v_late_minutes, v_late_count
  ...
  return jsonb_build_object(
    ...
    'attendance',jsonb_build_object('scheduledMinutes',round(v_scheduled_minutes,0),'workedMinutes',round(v_worked_minutes,0),'attendancePct',round(v_attendance_pct*100,1),'lateMinutes',round(v_late_minutes,0),'lateCount',v_late_count,'geofenceExitEvents',v_geofence_events),
