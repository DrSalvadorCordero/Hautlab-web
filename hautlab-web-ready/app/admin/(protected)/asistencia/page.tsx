    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="mt-4 max-w-3xl leading-7 text-muted">
          Control privado de entradas, salidas, horas trabajadas, retardos e incidencias. Las marcas usan hora del servidor en Mérida y no recopilan ubicación, fotografías ni biometría.
        </p>
      </section>
      <AttendanceDashboard />
    </div>
