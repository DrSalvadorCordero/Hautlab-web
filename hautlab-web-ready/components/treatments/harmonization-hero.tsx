...
export function HarmonizationHero() {
  ...
  return (
    <>
      <section className="relative isolate min-h-[calc(100svh-5rem)] overflow-hidden border-b border-line bg-[#0d0b09] text-bone">
        <div className="absolute inset-0 lg:left-[42%]">
          <Image
            ...
            className="hautlab-portrait-film object-cover object-[55%_48%]"
          />
        ...
        <div className="relative mx-auto flex min-h-[calc(100svh-5rem)] w-[min(1380px,calc(100%-24px))] flex-col justify-between px-2 pb-7 pt-6 sm:px-5 sm:pb-9 sm:pt-8 lg:px-7 lg:pb-10 lg:pt-9">
          ...
          <div className="relative z-10 mt-auto max-w-[72rem] pb-[12vh] pt-[42vh] sm:pt-[38vh] lg:pb-[8vh] lg:pt-24">
            <h1 className="max-w-[10ch] font-serif text-[clamp(4.3rem,9.6vw,9.5rem)] leading-[0.79] tracking-[-0.075em] text-bone">
              ARMONIZACIÓN
              <span className="block text-champagne">FACIAL</span>
            </h1>

            <p className="mt-7 max-w-[16ch] font-serif text-[clamp(2.2rem,4.2vw,4.5rem)] leading-[0.94] tracking-[-0.045em] text-bone/95">
        ...
        <style jsx>{`
          .hautlab-portrait-film {
            animation: hautlabPortraitFilm 8s ease-in-out infinite alternate;
